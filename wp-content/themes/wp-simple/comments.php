...
if ('open' == $post->comment_status) {
    ...
    $modified_defaults = array(
        ...
        'comment_field' => '<div class="col-md-8" style="float:none;"><p><label for="comment"></label><br /><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p></div></div>',
